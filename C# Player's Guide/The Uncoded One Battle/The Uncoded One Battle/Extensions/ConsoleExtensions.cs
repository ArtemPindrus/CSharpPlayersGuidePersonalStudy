namespace Extensions
{
    ...
    {
        public static string EqualSignLineBreak { get; private set; } = new('=', 50);
        ...
        public static string GetNotNullOrEmptyString(string prompt) {
            string? response;
            ...
            while (true) {
                ...
                if (string.IsNullOrEmpty(response)) WriteLineColor("Error! Empty or null string!", ConsoleColor.Red);
                else break;
            }
