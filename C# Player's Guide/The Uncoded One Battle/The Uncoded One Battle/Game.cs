namespace TheUncodedOneBattle
{
    ...
    internal class Game {
        ...
        private void RunBattle() {
            ...
            while (true) {
                ConsoleHelper.WriteLineColor("Heroes turns:", ConsoleColor.Blue);
                ...
                ConsoleHelper.WriteLineColor("Monsters turns:", ConsoleColor.Red);
        ...
        private void HandleDeath(object? sender, EventArgs e) {
            ...
            ConsoleHelper.WriteLineColor($"{character.Name} has been defeated!", ConsoleColor.Red);

            character.Dispose();
        }

        private void EndGame(Party winner) {
            if (winner == CurrentHeroParty)
                ConsoleHelper.WriteLineColor("The Uncoded One was defeated! Congrats, heroes!", ConsoleColor.Green);
            else if (winner == CurrentMonsterParty)
                ConsoleHelper.WriteLineColor("The Heroes were annihilated by The Uncoded One. The hope is lost...", ConsoleColor.Red);
